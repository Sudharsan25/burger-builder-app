        ...
        return(
            <div className={classes.Auth}>
                ...
                <form onSubmit={this.submitHandler}>
                    {form}
                    <Button btnType="Success">{!this.state.isSingup ? "SIGNIN" : "SIGNUP"}</Button>
                </form>
                <Button 
                clicked={this.swtichAuthModeHandler}
                btnType="Danger">
                    {this.state.isSingup ? 'ALREADY A USER? SIGNIN' : 'NEW USER ? SIGNUP' }
                    </Button>
            </div>
        );
    }
